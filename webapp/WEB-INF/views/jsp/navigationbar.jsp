...
<div>
    <c:choose>
        <c:when test="${globalmessagetype == 'info'}"><h4 class="alert alert-info">${globalmessagecontent}</h4></c:when>
        <c:when test="${globalmessagetype == 'error'}"><h4 class="alert alert-danger">${globalmessagecontent}</h4></c:when>
        <c:when test="${globalmessagetype == 'success'}"><h4 class="alert alert-success">${globalmessagecontent}</h4></c:when>
        <c:when test="${globalmessagetype == 'warning'}"><h4 class="alert alert-warning">${globalmessagecontent}</h4></c:when>
